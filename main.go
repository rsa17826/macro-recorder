...
var namedKeys = map[string]uint16{
	...
	"backspace": input.KEY_BACKSPACE, "bs": input.KEY_BACKSPACE, "space": input.KEY_SPACE, "spc": input.KEY_SPACE,
	...
	//
	"home": input.KEY_HOME, "end": input.KEY_END, "insert": input.KEY_INSERT, "ins": input.KEY_INSERT,
	"del": input.KEY_DELETE, "delete": input.KEY_DELETE,
	"pageup": input.KEY_PAGEUP, "pgup": input.KEY_PAGEUP, "pagedown": input.KEY_PAGEDOWN, "pgdown": input.KEY_PAGEDOWN,
	...
	"kpdot": input.KEY_KPDOT, "kp.": input.KEY_KPDOT, "kpslash": input.KEY_KPSLASH, "kp/": input.KEY_KPSLASH, "kpasterisk": input.KEY_KPASTERISK, "kpstar": input.KEY_KPASTERISK, "kp*": input.KEY_KPASTERISK,
	"kpminus": input.KEY_KPMINUS, "kp-": input.KEY_KPMINUS, "kpplus": input.KEY_KPPLUS, "kp+": input.KEY_KPPLUS, "kpenter": input.KEY_KPENTER, "kpequal": input.KEY_KPEQUAL, "kp=": input.KEY_KPEQUAL, "kp\\n": input.KEY_KPENTER,
